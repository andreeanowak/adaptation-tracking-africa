...
```{r}
adaptdata <- read.csv(file = "C:/Users/anowak/OneDrive - CGIAR/Desktop/Repositories/adaptation-tracking-africa/Data-Processed/AdaptationElementsProcessed.csv", fileEncoding = "Windows-1252")
```
